        ...
        <table id="report_list">
            <tbody>
                <tr>
                    ...
                    <th class="report_date">出勤時間</th>
                    <th class="report_date">退勤時間</th>
                ...
                <c:forEach var="report" items="${reports}" varStatus="status">
                    ...
                    <tr class="row${status.count % 2}">
                        ...
                        <td class="report_date"><fmt:formatDate value='${beginDay}' pattern='HH:mm' /></td>
                        <td class="report_date"><fmt:formatDate value='${finishDay}' pattern='HH:mm' /></td>
